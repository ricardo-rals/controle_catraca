...
REST_FRAMEWORK = {
    ...
    # Rate limit da API pública (HU-055). Só as views com throttle_scope
    # "api_publica" são afetadas; as rotas internas seguem sem limite.
    "DEFAULT_THROTTLE_CLASSES": ("rest_framework.throttling.ScopedRateThrottle",),
    "DEFAULT_THROTTLE_RATES": {
        "api_publica": config("API_PUBLICA_RATE", default="60/hour"),
    },
}
