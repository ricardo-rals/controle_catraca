...
urlpatterns = [
    ...
    path("dashboard/<int:importacao_id>/", dashboard_importacoes_view, name="dashboard_detalhe"),
    path("<int:importacao_id>/exportar-erros/", exportar_erros_csv_view, name="exportar_erros_csv"),
]
